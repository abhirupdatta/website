...
\mydot{-0.1em}
\item Review-panel National Science Foundation (NSF) Division of Mathematical Sciences (DMS), 2020
\item Scientific Program Committee for the 2020 International Indian Statistical Association conference (IISA).
\item Student poster competition judge, IISA INDSTAT (2019).
\item Session Chair, IISA INDSTATS (2019).
...
\subsection*{PEER REVIEW \ {\small \em  The numbers in parentheses indicate the count of manuscripts reviewed, excluding revisions.}} 
Advances in Statistical Climatology Meteorology and Oceanography (1), Annals of Applied Statistics (4), Bayesian Analysis (1), Biometrics (4), Biometrika (1), Brazilian Journal of Probability and Statistics (1), Computational Statistics and Data Analysis (CSDA) (3), Electronic Journal of Statistics (1), Environmetrics (2), IEEE Transactions on Pattern Analysis and Machine Intelligence (1), Journal of Agricultural Biological and Environmental Statistics (JABES) (1), Journal of the American Statistical Association Applications and Case Studies (JASA-ACS) (2), Journal of the American Statistical Association Theory and Methods (JASA-TM) (7), Journal of Computation and Graphical Statistics (JCGS) (4), Journal of Multivariate Analysis (JMVA) (1), Journal of the Royal Statistical Society Series B (JRSSB) (1), 
Journal of the Royal Statistical Society Series C (JRSSC) (1), Sankhya A (2), Scientific Reports (1), Spatial Statistics (3), Statistica Sinica (3), Statistical Computing (1), Statistics in Medicine (1)
...
\subsection*{PUBLICATIONS \ {\small \em  The white numbers in black boxes indicate first  author (including equal contributions) or senior author manuscripts, * indicates equal contributions.}}
...
\myben{0.4em}
\mine \textbf{Datta A}, Pita, A, Rao, A, Sithole, B, Mnisi, Z, and Baral, S.	{\dg Size Estimation of Key Populations in the HIV Epidemic in eSwatini using incomplete and misaligned capture-recapture data} {\it Annals of Applied Statistics (to appear)}
\mine \textbf{Datta A}, Fiksel J, Amouzou A, Zeger S. {\dg Regularized Bayesian transfer learning for population level etiological
	distributions} {\it Biostatistics (to appear)}
\mine \textbf{Datta A}, Banerjee S, Hodges JS., Gao, L. {\dg Spatial disease mapping using
	Directed Acyclic Graph Auto-Regressive (DAGAR) models} {\it Bayesian Analysis (to appear)}
...
\mine \textbf{Datta A}, Zou H. {\dg A note on cross-validation for Lasso under measurement
	errors} {\it Technometrics (to appear)}
...
{\it Statistica Sinica (to appear)}
...
\mycon{0.4em}
\mine \textbf{Datta, A,} Saha, A, Levy-Zamora, M, Buehler, Colby, Hao, L, Xiong, F, Gentner DR, Koehler K {\dg Statistical field calibration of a low-cost PM2.5 monitoring network in Baltimore}
\mine Fiksel J, \textbf{Datta A}, Amouzou A, Zeger S. {\dg Generalized Bayesian Quantification Learning}
\item B\'erub\'e S, \textbf{Datta A}, Li Q., Wang C, Louis TL. {\dg Percentile-based residuals for model assessment}
\item Gao, L., \textbf{Datta A}, Banerjee S, {\dg Spatial Modeling for Correlated Cancers Using Bivariate Directed Graphs}
\item Finley AO, \textbf{Datta A}, Banerjee S. (2019) {\dg spNNGP R package for Nearest Neighbor Gaussian Process models}
\ee
...
\item
{\bf BRISC ($6897$ CRAN downloads as of March 2, 2020)}
...
\item
{\bf calibratedVA (Github download stats not available)} %$\blacktriangleright$
...
\item 
{\bf spNNGP ($7774$ CRAN downloads as of March 2, 2020)} %$\blacktriangleright$
...
%\item \dn{Fiksel}, Jacob, Doctor of Philosophy, Biostatistics (2020, expected).
...
\subsection*{RESEARCH GRANT PARTICIPATION  \ {\small \em  Bold titles indicates grants funded as a Principal Investigator.}}  %\ {\tiny \em  The solid dots $\bullet$ indicate grants to IR.}}
...
\subsection*{INVITED PRESENTATIONS \ {\small \em  * indicates presentations at scientific meetings.}}

\smallskip

\myben{0.3em}
%\item *Aug 2020 Joint Statistical Meetings, Philadelphia, PA
\item *Mar 2020 Eastern North American Region Meetings (ENAR), International Biometric Society, Nashville, TN
