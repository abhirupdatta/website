...
\newpage
\subsection*{HONORS AND AWARDS}% (Selected)}

\noindent \textbf{Research awards:}
\mydot{-0.1em}
\item \vskip -4mm (2023) Abdel El-Shaarawi Early Investigator's Award, The International Environmetrics Society (TIES). This award is given  annually to an researcher within 12 years of completion of their PhD for their statistical contributions to Environmental Sciences.
\item (2021) Young Statistical Scientist Award (YSSA), International Indian Statistical Association (IISA). This annual award recognizes most outstanding contributions in Applications and Statistical Practice by a person under 44 years.
\item (2021) Early Investigator Award (EIA), American Statistical Association Section on Statistics and the Environment (ENVR). This annual award recognizes outstanding contributions to environmental statistics in the first 12 years after obtaining terminal degree. 
%\item (2020) Honorable mention: Lindley Prize, International Society for Bayesian Analysis (ISBA).
\item (2018) Honorable mention (Finalist): Savage Award (Applied Methodology), International Society for Bayesian Analysis (ISBA).
...
\mine * Heffernan C, Peng RD, Gentner D, Koehler K, \textbf{Datta, A} {A dynamic spatial filtering approach to mitigate
	underestimation bias in field calibrated low-cost sensor
	air-pollution data} {\it Annals of Applied Statistics (Accepted)}
...
\item Lin J, Buehler C, \textbf{Datta A}, Gentner D, Koehler K, Levy-Zamora M {Laboratory and Field Evaluation of a Low-cost Methane Sensor and Key Environmental Factors for Sensor Calibration}{\it Atmospheres (Accepted)}
...
\item
{\bf BRISC (2018) ($31349$ CRAN downloads as of Feb, 2023)} \\
...
\item 
{\bf spNNGP (2017) ($25051$ CRAN downloads as of Feb, 2023)} \\%$\blacktriangleright$
...
\item 
{\bf codalm (2020) ($16675$ CRAN downloads as of Feb, 2023)} \\%$\blacktriangleright$
...
\item
{\bf RandomForestsGLS (2021) ($14478$ CRAN downloads as of Feb, 2023)} \\
...
\item Bora Jin (August, 2023 -, Expected )
\ee
...
\smallskip
\subsection*{Scientific Advisory Committees}
2023 -  \quad \quad Pathology-informed Reference Death Archive for the  World Health Organization
...
\begin{enumerate}
	...
	%Applications and Case Studies (JASA-ACS) %(3)
...
\mydot{-0.1em}
\item (2020) Grant review-panel National Science Foundation (NSF) Division of Mathematical Sciences (DMS)
\ee
...
\newpage
\subsection*{PLENARY TALK}
\myben{0.3em}
\item July 2023 The International Environmetrics Society Meeting,  Peterborough, Canada
\ee
...
\myben{0.3em}
\item May 2023 (expected) Center for Statistics and the Social Sciences, University of Washington, Seattle
\item May 2023 (expected), Statistics, Computer Science, and Mathematics Department, The Public University of Navarre, Pamplona, Spain
...
\item May 2021 Center for Disease Control (CDC) Division of Global HIV and TB’s Key Population Surveillance Team 
...
\item Dec 2017 10th International Conference of the ERCIM WG on Computational and Methodological Statistics, London, UK.
