...
\item Eastern North American Region (ENAR)
...
\mine \textbf{Datta A}, Banerjee S, Hodges JS. {\it Spatial disease mapping using
	Directed Acyclic Graph Auto-Regressive (DAGAR) models} \dg{Bayesian Analysis (to appear)}
...
PB. {\it Robustness of trait connections between multiple plant organs across
	environmental gradients, growth forms} \dg{Global Ecology and Biogeography (to appear)}
\mine \textbf{Datta A}, Zou H. {\it A note on cross-validation for Lasso under measurement
	errors} \dg{Technometrics (to appear)}
...
\item Zhang L, \textbf{Datta A}, Banerjee S. (2019) {\it Practical Bayesian Inference for Massive Spatial Data on Modest Computing Environments}
\dg{Statistical Analysis and Data Mining: The ASA Data Science Journal 12.3:197-209.}
...
\dg{ Journal of Computational and Graphical Statistics 1-14.}
\item  Heaton MJ, \textbf{Datta A}, Finley AO, Furrer R, Guhaniyogi R, Gerber F, Gramacy RB, Hammerling D, Katzfuss M, Lindgren F, Nychka DW, Sun F, Zammit-Mangion A. (2018)
{\it A Case Study Competition Among Methods for Analyzing Large Spatial Data}
\dg {Journal of Agricultural, Biological and Environmental Statistics 1-28.}
...
\mine \textbf{Datta A}, Fiksel J, Amouzou A, Zeger S. {\it Regularized Bayesian transfer learning for population level etiological
	distributions} {Under revision (Biostatistics)}
\mine \textbf{Datta A}, Pita, A, Rao, A, Sithole, B, Mnisi, Z, and Baral, S.	\textit{Size Estimation of Key Populations in the HIV Epidemic in eSwatini using incomplete and misaligned capture-recapture data} {Under revision (Annals of Applied Statistics)}
\item B\'erub\'e, S, \textbf{Datta A}, Li Q., Wang C, Louis TL. \textit{Percentile-based residuals for model assessment} {Under revision (JSPI)}
\ee

\subsection*{Manuscripts In Preparation (Only manuscripts which have a draft)}

\mycon{0.4em}
\mine  Fiksel, J, \textbf{Datta A}, Amouzou A, Zeger S. {\it Generalized Bayesian Quantification Learning for Dataset Shift}
\mine  Saha, A., \textbf{Datta A}, Basu, S. {\it Random forests with Gaussian process correlated errors for spatio-temporally dependent data}
\mine  Dey, D., \textbf{Datta A}, Banerjee, S. {\it Graphical Mat\'ern covariance functions for highly multivariate spatial data}
\mine  \textbf{Datta A}, Saha, A., Levy-Zamora, M., Buehler, B., Lei, H., Gentner, D., Koehler, K. {\it Statistical calibration of a low-cost PM2.5 network in Baltimore}
\item Finley, A., \textbf{Datta A}, Banerjee, S. {\it spNNGP R package for Nearest Neighbor Gaussian Process models}
\ee
...
\item[$\bullet$]
{\it Highly multivariate geo-statistics using graphical models (NSF DMS-1915803)}\\[0.0em]
...
\item Member, Graduate students admissions committee, Biostatistics Retreat (2019 - present)
