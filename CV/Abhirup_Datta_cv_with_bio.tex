...
%
%Dr. Abhirup (Abhi) Datta completed his Ph.D. in Biostatistics from the University of Minnesota in 2016. He was an Assistant Professor in Department of Biostatistics at the Johns Hopkins University from July 2016 to December 2021, and is currently an Associate Professor there since January 2022. 
%
%\textbf{Research:} Dr. Datta's research focuses on developing statistical methods for geospatial data with applications to air pollution, forestry, ecology, infectious disease modeling, and on Bayesian hierarchical models for multi-source data with applications to global health. Dr. Datta has 39 peer-reviewed articles (published or accepted), in 21 of which Dr. Datta is the first or senior author, and 11 of which were published in top-tier statistical or scientific journals like Journal of the American Statistical Association (JASA), Annals of Statistics (AoS), Annals of Applied Statistics (AoAS), Biostatistics, Biometrics, and the Proceedings of the National Academy of Sciences (PNAS). In 2021, Dr. Datta was awarded the {\it\textbf{Young Statistical Scientist Award (YSSA)}} -- a prestigious award by the International Indian Statistical Association (IISA) for early and mid career researchers. 
%
%{\it \textbf{Spatial and environmental research:}} Dr. Datta has been leading highly innovative and impactful research in spatial statistics and machine learning for analysis of large and complex environmental data. His work on Nearest Neighbor Gaussian Processes (NNGP) has become one of the most widely used methods for scalable analysis of massive geospatial data. The original NNGP paper led by Dr. Datta, published in 2016 in JASA, has been cited nearly 500 times and was one of {\it\textbf{the top-5 most cited papers in JASA}} from 2016-2020. Dr. Datta was awarded the 2021 {\it\textbf{Early Investigator Award}} by the American Statistical Association (ASA) Section on Statistics and the Environment (ENVR) for contributions to spatial big data methodology and their environmental applications. As principal investigator, Dr. Datta has been awarded an {\it\textbf {R01 grant by the National Institute of Environmental Health Sciences and an NSF grant}} for development of spatial methods. 
%
%{\it\textbf{Global health research:}} Dr. Datta has been developing Bayesian methods to understand disease burden from multi-source data in many low and middle income countries (LMICS) like Cote d'Ivoire, eSwatini and Mozambique. He is currently leading a high impact global health project aimed to improve cause-specific mortality estimates for children and neonates. %The primary data on cause-specific mortality in LMICS comes . 
%Dr. Datta has demonstrated that the estimates of mortality in LMICS, often derived from verbal autopsies, are highly biased and has developed Bayesian transfer learning methods for bias-correction of verbal autopsy. %The method has been used to produce improved cause-specific mortality estimates for children and neonates in Mozambique. 
%He has been recently awarded a grant {\it\textbf{PI grant by the Bill and Melinda Gates Foundation}} for broader application of the method to improve cause-specific mortality estimates globally. 
%
%\textbf{Mentoring:} Dr. Datta has advised or is advising 7 PhD students, 3 ScM students and 1 post-doctoral fellow in the Biostatistics department at JHU. His mentees have received JSM student paper awards and have been inducted in the Delta Omega Honorary Society on multiple occasions. %After graduation, his mentees have pursued post-doctoral fellowships at University of Washington, University of Pennsylvania and the National Institute of Mental Health. 
%He has served as a {\it\textbf{mentor for the 2022 Diversity Summer Internship Program}} in the Johns Hopkins School of Public Health (JHSPH). Dr. Datta was awarded the {\it\textbf{2019-2020 AMTRA Award (Advising, Mentoring, and Teaching Recognition Award)}} by JHSPH Student Assembly. He has also received {\it\textbf{three Excellence in Teaching Awards}} from JHSPH. 
%\vspace*{10mm}
%
%
...
\mydot{-0.1em}
\item \vskip -4mm  (2021) Young Statistical Scientist Award (YSSA) (Applications), International Indian Statistical Association (IISA) . This prestigious award recognizes "outstanding contribution made by members in each of the areas of Theory and Methods, Applications and Statistical Practice." The nominees must strictly be under the age of 44 throughout the award calendar year.
...
\item (2022) Excellence in Teaching, Johns Hopkins Bloomberg School of Public Health, Fourth Quarter, Probability IV.
\item (2021) Excellence in Teaching, Johns Hopkins Bloomberg School of Public Health, Fourth Quarter, Probability IV.
\item (2018) Excellence in Teaching, Johns Hopkins Bloomberg School of Public Health,
Fourth Quarter, Probability IV.
...
\item (2022-2026) R01 award (USD 1.3M) from the National Institute of Environmental Health Sciences (NIEHS) for developing {\em ``Statistical methods for air-pollution studies using low-cost monitors"}
\item (2021-2024) Grant award (USD 1.1M) from the Bill \& Melinda Gates Foundation for {\em ``Broadening the applicability of minimally-invasive-tissue-sampling (MITS)-based verbal autopsy (VA) calibration to improve global mortality estimates''}
\item (2019-2023) Grant award (USD 180K) from National Science Foundation (NSF) Division of Mathematical Sciences (DMS) for {\em ``Highly multivariate geo-statistics using graphical models"}
\item (2018-2019) Grant award (USD 71K) from the Bloomberg American Health Initiative Spark Award for {\em``Statistical Maps of Air Quality in Baltimore City Using Low-Cost Monitoring Data"}\\
...
\newpage
\subsection*{PUBLICATIONS \ {\small \em  The white numbers in black boxes indicates manuscripts where Dr. Datta is the first author (including equal contributions) or senior/corresponding author; * indicates a mentored student or post-doctoral fellow of Dr. Datta; $^\dag$ indicates equal contributions.}}
...
\vskip-3mm \subsection*{Statistics Methods and Theory}
\myben{0.4em}
\mine *Dey D, \textbf{Datta A}, Banerjee S (2022) {\dg Graphical Gaussian Processes for highly multivariate spatial data} {\it  Biometrika (In press)}
\begin{itemize}
...
\item Wikle CK, \textbf{Datta A}, Hari BV, Boone EL, Sahoo I, Kavila I, Castruccio S, Simmons SJ, Burr WS, Chang W {\dg An Illustration of Model Agnostic Explainability Methods Applied to Environmental Data} {\it Environmetrics}

\item *Saha A, \textbf{Datta A}, Banerjee S {\dg Scalable Predictions for Spatial Probit Linear Mixed Models Using Nearest Neighbor Gaussian Processes} {\it Journal of Data Science (In press)}

\mine *Saha A, Basu S, and \textbf{Datta A.}, (2022). {\dg RandomForestsGLS: An R package for Random Forests for dependent data} {\it Journal of Open Source Software, 7(70), 3780}

\item Gao L., \textbf{Datta A}, Banerjee S (2022) {Hierarchical Multivariate Directed Acyclic Graph Auto-Regressive (MDAGAR) Models for Spatial Diseases Mapping} {\it Statistics in Medicine (In press)}

\item Seal S, \textbf{Datta A}, Basu S (2022) {\dg Efficient Estimation of SNP Heritability using Gaussian Predictive Process in Large scale Cohort Studies} {\it PLOS Genetics (In press)}
...
\item Butler EE, Wythers KR, Flores-Moreno, H, Chen M, \textbf{Datta A}, Ricciuto DE, Atkin OK, Kattge J, Thorton PM, Banerjee A, Reich PB (2021) {\dg Updated respiration routines alter spatio-temporal patterns of carbon cycling in a global land surface model} {\it Environmental Research Letters 16(10) p. 104015.}
...
\mycon{0.4em}
\mine * Heffernan C, Koehler K, Levy-Zamora M, Buehler C, Gentner D, Peng RD, \textbf{Datta, A} {\dg A machine learning based interrupted time series framework for studying causal changes in air pollution due to policy interventions: A case study in COVID-19 lockdowns}
\begin{itemize}
...
\mine * Heffernan C, Peng RD, Gentner D, Koehler K, \textbf{Datta, A} {\dg Gaussian Process filtering for calibration of low-cost air-pollution sensor network data}
...
\item Wang G, \textbf{Datta A}, Lindquist M {\dg Improved fMRI-based Pain Prediction using Bayesian Group-wise Functional Registration}

\item *Dey D, \textbf{Datta A}, Banerjee S (2022) {\dg Modeling Multivariate Spatial Dependencies Using Graphical Models}

\item Weber L, *Saha A, \textbf{Datta A}, Hansen K, Hicks S {\dg nnSVG: scalable identification of spatially variable genes using nearest-neighbor Gaussian processes}

\item *Gilbert B, \textbf{Datta A}, Casey JA, Ogburn EL {\dg Approaches to spatial confounding in geostatistics}

\item Lin J, Buehler C, \textbf{Datta A}, Gentner D, Koehler K, Levy-Zamora M {\dg Laboratory and Field Evaluation of a Low-cost Methane Sensor and Key Environmental Factors for Sensor Calibration}

\mine *Dey D, \textbf{Datta A}, Banerjee S {\dg On the Relationship between Graphical Gaussian Processes and Functional Gaussian Graphical Models}
\ee
%
\newpage
...
\begin{enumerate}
	\item Advances in Statistical Climatology Meteorology and Oceanography %(1)
	\item American Journal of Epidemiology (AJE) %(1)
	\item  Artificial Intelligence and Statistics Conference 2021 (AISTATS 2021) %(3)
	\item Annals of Statistics %(1)
	\item Annals of Applied Statistics %(6)
	\item Bayesian Analysis %(1)
	\item Biometrics %(4)
	\item Biometrika %(1)
	\item Biostatistics %(1)
	\item Brazilian Journal of Probability and Statistics %(1)
	\item Canadian Journal of Statistics %(2)
	\item Canadian Journal of Statistics %(2)
	\item Computational Statistics and Data Analysis (CSDA) %(4)
	\item Electronic Journal of Statistics %(1)
	\item Environmental Health Policy (EHP) %(1)
	\item Environmental Science and Technology (ES\&T) %(1)
	\item Environmetrics %(2)
	\item Harvard Data Science Review %(1)
	\item IEEE Transactions on Pattern Analysis and Machine Intelligence %(1)
	\item Journal of Agricultural Biological and Environmental Statistics (JABES) %(1)
	\item Journal of the American Statistical Association Applications and Case Studies (JASA-ACS) %(3)
	\item Journal of the American Statistical Association Theory and Methods (JASA-TM) %(10)
	\item Journal of Computation and Graphical Statistics (JCGS) %(4)
	\item Journal of Multivariate Analysis (JMVA) %(1)
	\item Journal of the Royal Statistical Society Series B (JRSSB) %(4)
	\item Journal of the Royal Statistical Society Series C (JRSSC) %(1)
	\item Sankhya A %(2)
	\item Scientific Reports %(1)
	\item Spatial Statistics %(4)
	\item Statistica Sinica %(3)
	\item Statistics and Computing %(3)
	\item Statistics in Medicine %(2) 
\end{enumerate}
...
\subsection*{Invited seminars or presentations  ($^\#$ indicates posters)}
\myben{0.3em}
...
\item Sep 2022, Department of Population, Family and Reproductive Health, Johns Hopkins University, Baltimore, MD
...
\item Dec 2016 Platinum Jubilee International Conference on Applications of Statistics, Calcutta University, Kolkata, India.
\ee

\subsection*{Contributed presentations ($^\#$ indicates posters)}
