...
\item Scientific Program Committee for the 2021 International Indian Statistical Association conference (IISA).
...
\myben{0.4em}
\mine \textbf{Datta, A,} Saha, A, Levy-Zamora, M, Buehler, Colby, Hao, L, Xiong, F, Gentner DR, Koehler K {\dg Statistical field calibration of a low-cost PM2.5 monitoring network in Baltimore} {\it Atmospheric Environment (to appear)}
\item Finley AO, \textbf{Datta A}, Banerjee S. (2019) {\dg spNNGP R package for Nearest Neighbor Gaussian Process models} {\it Journal of Statistical Software (Accepted with minor revisions)}
\mine \textbf{Datta A}, Pita, A, Rao, A, Sithole, B, Mnisi, Z, and Baral, S.	{\dg Size Estimation of Key Populations in the HIV Epidemic in eSwatini using incomplete and misaligned capture-recapture data} {\it Annals of Applied Statistics (2020)}
\mine \textbf{Datta A}, Fiksel J, Amouzou A, Zeger S. {\dg Regularized Bayesian transfer learning for population level etiological
	distributions} {\it Biostatistics (2020)}
\mine \textbf{Datta A}, Zou H. {\dg A note on cross-validation for Lasso under measurement
	errors} {\it Technometrics (2019)}
\mine \textbf{Datta A}, Banerjee S, Hodges JS., Gao, L. (2019) {\dg Spatial disease mapping using
	...
	\item Gao, L., \textbf{Datta A}, Banerjee S, {\dg Spatial Modeling for Correlated Cancers Using Bivariate Directed Graphs} {\it Annals of Cancer Epidemiology (to appear)}
...
\mycon{0.4em}
\mine Saha A, Basu S, \textbf{Datta A} {\dg Random forests for dependent data}
\mine Fiksel J, Zeger S, \textbf{Datta A} {\dg A Transformation-free Linear Regression for Compositional Outcomes and Predictors}
...
\item 
{\bf spNNGP (2017) ($11050$ CRAN downloads as of July 11, 2020)} \\%$\blacktriangleright$
...
\item 
{\bf codalm (2020) ($700$ CRAN downloads as of Aug, 2020)} \\%$\blacktriangleright$
...
\myben{-0.1em}
%\item \dn{Tang}, Bohao. Doctor of Philosophy, Biostatistics (2020, expected).
...
\subsection*{RESEARCH GRANT PARTICIPATION  \ {\small \em  Bold titles indicates grants funded as a Principal or Co-Principal Investigator.}}  %\ {\tiny \em  The solid dots $\bullet$ indicate grants to IR.}}
...
\myben{0.3em}
\item *Aug 2020 (expected) Joint Statistical Meetings, Philadelphia, PA
